...
public class JugadorService {
    ...
    public JugadorService() {
        ...
        if (gm.JugadoresSize()==0) {
            try {
                ...
                this.gm.addBadgets("Antonio","master del universo","https://cdn.pixabay.com/photo/2017/07/11/15/51/kermit-2493979_1280.png");
                this.gm.addBadgets("Antonio","rey de xxx"," ");
                this.gm.addBadgets("Lobi","becario enfurismado","https://cdn.pixabay.com/photo/2017/07/11/15/51/kermit-2493979_1280.png");
                this.gm.addBadgets("Lobi","el bachiller"," ");
            } catch (Throwable e) {
    ...
    @GET
    @ApiOperation(value = "get badgets de un jugador")
    @ApiResponses(value = {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response getBadgets(@PathParam("username") String username) {
        List<Badges> badgets = this.gm.getBadgets(username);
        GenericEntity<List<Badges>> entity = new GenericEntity<>(badgets) {
        };
        return Response.status(201).entity(entity).build();
    }
