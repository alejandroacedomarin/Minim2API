...
public class GameManagerImpl implements GameManager {
    ...
    @Override
    public List<Badges> getBadgets(String username) {
        return jugadores.get(username).getBadges();
    }

    @Override
    public Jugador addBadgets(String username,String name, String avatar) {
        Badges b = new Badges(name,avatar);
        List<Badges> bb=jugadores.get(username).getBadges();
        bb.add(b);
        jugadores.get(username).setBadges(bb);
